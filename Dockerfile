...
RUN apt update; apt install -y docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin  kmod    iproute2 iptables fuse-overlayfs;
# choose DOCKER_DRIVER (storage) in auto with fall down
